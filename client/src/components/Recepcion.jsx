                ...
                <div className="text-start">
                  ...
                  <div>
                    <form onSubmit={onSubmit} className="bg-dark p-4 rounded">
                      <div id="carouselRecibir" className="carousel slide" data-bs-ride="carousel">
                        <div className="carousel-inner">
                          <div className="carousel-item active">
                            ...
                            <div className='text-center'>
                              <button className="btn btn-primary me-2 fs-3 mt-2" type="button" data-bs-target="#carouselRecibir" data-bs-slide="next" disabled={!isValid}>Realizar traspaso</button>
                            </div>
                          </div>
                          {/* Carousel page 2 */}
                          <div className="carousel-item">
                            ...
                            <div className="mb-3 text-center">
                              {processing ? (
                                ...
                                <div>
                                  <button className="btn btn-primary me-2 fs-3 mt-2" type="button" data-bs-target="#carouselRecibir" data-bs-slide="prev">{"<"}
                                  </button>
